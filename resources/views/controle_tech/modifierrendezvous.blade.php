...
@section('content')
<main class="ajt_rdv">
    <h1>Modifier Ce Rendez-vous</h1> <br>
            @if (count($errors) > 0)
            ...
            @endif
    <form class="row" method="post" action="{{ url('/controletech/rendezVous/modifierrendezvous/rdvupdate/'.$Rendezvous->id) }}" role="form" >
        @csrf
        @method('put')
        <div class="mb-3 col-md-6">
          <label for="email" class="form-label">Email address <span class="red">*</span> </label>
          <input type="email" class="form-control" id="email" name="Email" value="{{$Rendezvous->email}}">
          <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
        </div>
        <div class="mb-3 col-md-6">
            <label for="Nom" class="form-label">Nom <span class="red">*</span> </label>
            <input type="text" class="form-control" id="Nom" name="name"  value="{{$Rendezvous->nom}}">
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="text" class="form-control" id="Prenom" name="firstname"  value="{{$Rendezvous->prenom}}">
        </div>
        <div class="mb-3 col-md-6">
            <label for="Telephone" class="form-label">Telephone <span class="red">*</span> </label>
            <input type="number" class="form-control" id="Telephone" name="telephone"  value="{{$Rendezvous->telephone}}">
        </div>
        <div class="mb-3 col-md-6">
            <label for="Modele" class="form-label">Modele de voiture <span class="red">*</span> </label>
            <input type="text" class="form-control" id="Modele" name="Modele"  value="{{$Rendezvous->modele}}">
        </div>
        <div class="mb-3 col-md-6">
            <label for="Nom" class="form-label">Nom de voiture <span class="red">*</span> </label>
            <input type="text" class="form-control" id="Nom" name="name_voiture"  value="{{$Rendezvous->nomv}}">
        </div>
        <div class="mb-3 col-md-6">
            <label for="Matricule" class="form-label">Matricule de voiture <span class="red">*</span> </label>
            <input type="number" class="form-control" id="Matricule" name="Matricule"  value="{{$Rendezvous->matricule}}">
        </div>
        <div class="mb-3 col-md-6">
            <label for="Type" class="form-label">Type de voiture <span class="red">*</span> </label>
            <input type="text" class="form-control" id="Type" name="Type"  value="{{$Rendezvous->type}}">
        </div>
        <div class="mb-3 col-md-6">
        ...
        <br><br><br>
        <button type="submit" class=" col-md-1 btn btn-primary">Envoyer</button>
      </form>
</main>
